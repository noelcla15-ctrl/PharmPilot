...
# ==========================================
try:
    # This looks for the key in the secure cloud vault OR your local secure file
    GOOGLE_API_KEY = st.secrets["GOOGLE_API_KEY"]
except FileNotFoundError:
    st.error("🚨 API Key not found! Please set it in .streamlit/secrets.toml (Local) or Advanced Settings (Cloud).")
    st.stop()
